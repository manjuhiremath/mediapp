...
function ViewLabTest() {
  ...
  const { updateLabTest, loading, setLoading } = useLabTestContext();
  ...
  const handleValidation = () => {
    ...
    let formData = {
      ...
      emergencyServices: fetchedDetails.about.emergencyServices,
    };
  ...
  const handleSubmit = async () => {
    ...
    try {
      setErrorMain('');
      await updateLabTest(state.id, BasicDetail, details);
