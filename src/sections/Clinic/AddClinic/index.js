...
function AddClinic() {
  ...
  const { addClinic, loading } = useClinicContext();
  ...
  const handleValidation = () => {
    const fieldsToValidate = [
      ...
      { name: 'servicesProvided', value: servicesProvided },
  ...
  const handleSubmit = async () => {
    ...
    try {
      await addClinic(ClinicDetailsMain, BasicDetail, details);
      setSnackbarMessage("Clinic details saved successfully!");
  ...
  const ClinicProfileFields = [
    [
      ...
      },
      {
        ...
        value: specialties,
        required: true,
        onChange: handleMultiSelectChange(setSpecialties),
    ...
    [
      ...
      },
      {
        ...
        value: accessibility,
        multiple:true,
        onChange: handleMultiSelectChange(setAccessibility),
        required: true,
  ...
  const aboutDetalisFields= [
    [
      ...
      //   type: 'text',
      //   value: awards,
      //   onChange: handleChange(setAwards, 'awards'),
      //   required: false,
      //   error: !!errors.awards,
      ...
      // },
      {
        ...
        type: 'text',
        value: affiliations,
        onChange: handleChange(setAffiliations, 'affiliations'),
        required: false,
      ...
      },
      {
        ...
        onChange:handleMultiSelectChange(setServicesProvided),
        require:'true',
