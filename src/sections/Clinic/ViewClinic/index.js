...
import { HosAccessibilityFeatures, HosServicesProvidedList, HosSpecialtiesList, HosFacilitiesList } from '../../../_mock/data';
// import { useHospitalContext } from '../../../firebase/Service';
...
function ViewClinic() {
  ...
  const { updateClinic, loading, setLoading } = useClinicContext();
  ...
  const handleSubmit = async () => {
    ...
    try {
      setErrorMain('');
      await updateClinic(state.id, BasicDetail, details);
