...
function AddExtra() {
  ...
  // const { addPharmacy, loading } = usePharmacyContext();
  const { addExtra, loading } = useExtraContext();
  ...
  const validateField = (name, value) => {
    ...
    switch (name) {
      ...
      case 'address':
        ...
        break;
      //case 'description':
//if (!value) error = 'Descritpion is required';
       // break;
      case 'city':
  ...
  const handleSubmit = async () => {
    ...
    try {
      await addExtra(ClinicDetailsMain, BasicDetail, details);
      setSnackbarMessage("Extra details saved successfully!");
