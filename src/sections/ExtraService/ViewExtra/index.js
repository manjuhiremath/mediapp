...
function ViewExtra() {
  ...
  const { updateExtra, loading, setLoading } = useExtraContext();
  ...
  const handleValidation = () => {
    const fieldsToValidate = [
      ...
      { name: 'servicesProvided', value: hospitalData.servicesProvided },
  ...
  const handleSubmit = async () => {
    ...
    const BasicDetail = {
      ...
      servicesProvided: hospitalData.servicesProvided,
    ...
    try {
      setErrorMain('');
      await updateExtra(state.id, BasicDetail, details);
      setSnackbarMessage("Service details saved successfully!");
  ...
  const hospitalProfileFields = [
    ...
    [{
      ...
      value: hospitalData?.servicesProvided,
      multiSelectedItems: hospitalData.servicesProvided,
      onChange: handleMultiSelectChangeData(setHospitalData, 'servicesProvided'),
    },]
  ];
